// @ts-check
/**
 * @import { DPoPState, DPoPSignatureProviderOptions } from "./keycloak-dpop.js"
 */
/* global indexedDB */
...
export class DPoPSignatureProvider {
    ...
    async init() {
        ...
        if (state) {
            ...
            if (storedAlg.name !== expectedParams.name || (expectedParams.namedCurve && storedAlg.namedCurve !== expectedParams.namedCurve)) {
